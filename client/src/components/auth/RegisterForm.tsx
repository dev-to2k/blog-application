    ...
    <form className="space-y-4" method="POST" onSubmit={handleSubmit}>
      ...
      <div className="rounded-md shadow-sm -space-y-px">
        <div className="grid gap-6">
          ...
          <div className="col-span-12">
            <label htmlFor="account" className="block text-sm font-medium text-gray-700">Email/Phone
              number</label>
          ...
          <div className="col-span-12">
            <label htmlFor="cd_password" className="block text-sm font-medium text-gray-700">Confirm password</label>
            <input type="password" name="cf_password" id="cd_password" autoComplete="given-name" value={cf_password}
                   onChange={handleChangeInput}
                   className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"/>
          </div>
        </div>
